...
public class LiveLockDemo {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println();
        List<Philosopher> philosophers = eatSushi(Philosopher.ImpatientPhilosopher::new);
        Thread.sleep(2_000);
        ...
        Thread.sleep(2_000);
        System.out.println();
        System.out.println("Yevhen: You were so impatient, didn't manage to use 3 Chopsticks together.");
        System.out.println("        By trying again immediately you've spent a lot of effort with no progress!");
        System.out.println("        I would like to have dinner with more patient Philosophers.");
        System.out.println("        Let's have one more:");
        System.out.println();
        eatSushi(Philosopher.PatientPhilosopher::new);
        Thread.sleep(5_000);
        System.out.println();
    ...
    static List<Philosopher> eatSushi(Function<String, Philosopher> factory) {
        List<ChopsticksPair> pairs = new ChopsticksContainer.CircularChopsticks().getPairs();
