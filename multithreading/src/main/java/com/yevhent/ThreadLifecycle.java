...
class ChefOlivia extends Thread {
    ...
    public void run() {
        System.out.println("Olivia: I'm reading sausage weigh ..." + time());
        sausage.weigh(100);

        System.out.println("Olivia: I'm waiting for sausage to thaw ..." + time());
        holdOn(sausage);

        System.out.println("Olivia: I'm cutting sausage ..." + time());
        holdOn(3000);

        System.out.println("Olivia: I'm done cutting sausage." + time());
    }
}
...
class Sausage extends Thread {
    ...
    public void run() {
        System.out.println("Sausage: I'm calculating my weigh ..." + time());
        weigh(3000);
        System.out.println("Sausage: I calculated my weigh and started thawing ..." + time());
        holdOn(3000);
        System.out.println("Sausage: I'm thawed." + time());
    }
